...
class Report(models.Model):
    REPORT_TYPES = [('superficial','superficial'),('tuberia','tuberia'),('domiciliaria','domiciliaria'),('obstruido','obstruido')]
    STATUS_CHOICES = [('Recibido','Recibido'),('En revisión','En revisión'),('En atención','En atención'),('Resuelto','Resuelto'),('Cerrado','Cerrado')]
...
class Tramite(models.Model):
    STATUS = [('Creado','Creado'),('En tramite','En tramite'),('Completado','Completado')]
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(User, null=True, on_delete=models.SET_NULL)
